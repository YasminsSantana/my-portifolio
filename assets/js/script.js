const translations = {
    en: {
        ...
        hero_subtitle: "A creative designer passionate about crafting beautiful user experiences.",
        hero_button: "View My Work",
        whoami_title: "Who Am I?",
        about_me_heading: "About Me",
        about_me_p1: "Hello! I'm a passionate designer and illustrator with a love for creating vibrant and engaging digital experiences. My work is heavily inspired by cute aesthetics and functional design. I believe that good design should not only look beautiful but also solve problems and bring joy to users.",
        about_me_p2: "When I'm not designing, you can find me sketching, exploring new cafes, or playing with my dog. Feel free to look through my work and get in touch!",
    ...
    es: {
        ...
        hero_subtitle: "Una diseñadora creativa apasionada por crear hermosas experiencias de usuario.",
        hero_button: "Ver Mi Trabajo",
        whoami_title: "¿Quién Soy?",
        about_me_heading: "Sobre Mí",
        about_me_p1: "¡Hola! Soy una diseñadora e ilustradora apasionada con un amor por crear experiencias digitales vibrantes y atractivas. Mi trabajo está muy inspirado en la estética linda y el diseño funcional. Creo que un buen diseño no solo debe ser hermoso, sino también resolver problemas y alegrar a los usuarios.",
        about_me_p2: "Cuando no estoy diseñando, me puedes encontrar dibujando, explorando nuevos cafés o jugando con mi perro. ¡Siéntete libre de ver mi trabajo y ponerte en contacto!",
    ...
    pt: {
        ...
        hero_subtitle: "Uma designer criativa apaixonada por criar belas experiências de usuário.",
        hero_button: "Veja Meu Trabalho",
        whoami_title: "Quem Sou Eu?",
        about_me_heading: "Sobre Mim",
        about_me_p1: "Olá! Sou uma designer e ilustradora apaixonada por criar experiências digitais vibrantes e envolventes. Meu trabalho é fortemente inspirado pela estética fofa e pelo design funcional. Acredito que um bom design não deve apenas ser bonito, mas também resolver problemas e trazer alegria aos usuários.",
